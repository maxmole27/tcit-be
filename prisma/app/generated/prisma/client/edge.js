...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/max/development-2025/tcit/tcit-posts-manager-be/prisma/app/generated/prisma/client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/Users/max/development-2025/tcit/tcit-posts-manager-be/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": "../../../../../.env",
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        "fromEnvVar": "DATABASE_CONNSTRING",
        "value": "postgresql://admin:hola1234@localhost:5433/postmanager"
      }
    }
  },
  "inlineSchema": "datasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_CONNSTRING\")\n}\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"app/generated/prisma/client\"\n}\n\nmodel Post {\n  id          Int      @id @default(autoincrement())\n  name        String\n  description String\n  createdAt   DateTime @default(now())\n  updatedAt   DateTime @updatedAt\n}\n",
  "inlineSchemaHash": "56b7a80915cdfcdec142cccf99a87d218471cd753150334e7a06fe1554fa69cd",
  "copyEngine": true
}
config.dirname = '/'
...
config.injectableEdgeEnv = () => ({
  parsed: {
    DATABASE_CONNSTRING: typeof globalThis !== 'undefined' && globalThis['DATABASE_CONNSTRING'] || typeof process !== 'undefined' && process.env && process.env.DATABASE_CONNSTRING || undefined
  }
})
